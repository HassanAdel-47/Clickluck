            ...
            <nav class="navbar navbar-expand-xl align-items-center p-0">
                ...
                <div class="collapse navbar-collapse mt-lg-0 mt-3" id="navbarSupportedContent">
                    <ul class="navbar-nav main-menu me-auto">
                        ...
                        <li><a class="<?php echo e(menuActive(['lottery', 'lottery.details'])); ?>"
                                href="<?php echo e(route('lottery')); ?>"><?php echo app('translator')->get('Lotteries'); ?></a></li>

                        <?php if(@$pages): ?>
                        <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li><a class="<?php echo e(menuActive('pages', [$data->slug])); ?>"
                                href="<?php echo e(route('pages', [$data->slug])); ?>"><?php echo e(__($data->name)); ?></a></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>

                        <li><a class="<?php echo e(menuActive('blog')); ?>" href="<?php echo e(route('pages', ['blog'])); ?>"><?php echo app('translator')->get('Blog'); ?></a>
                        </li>
                        <li><a class="<?php echo e(menuActive('contact')); ?>" href="<?php echo e(route('contact')); ?>"><?php echo app('translator')->get('Contact'); ?></a>
                        </li>
                    </ul>
                    <div class="nav-right">
                        <?php if(auth()->guard()->check()): ?>
                        <a class="btn btn-sm btn--base me-sm-3 me-2 btn--capsule <?php echo e(menuActive('user.home')); ?> px-3"
...
</header><?php /**PATH D:\Web Development\Lotto\ClickLuck\ClickLuck\resources\views/templates/basic/partials/header.blade.php ENDPATH**/ ?>