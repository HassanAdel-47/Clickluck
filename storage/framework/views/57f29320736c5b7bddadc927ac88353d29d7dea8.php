        ...
        <div class="testimonial-slider">
            ...
            <div class="single-slide">
                <div class="testimonial-item rounded-3">
                    <div class="ratings">
                        <?php for($i = 0; $i < 5; $i++): ?> <?php if($i < $testimonial->data_values->rating): ?>
                    ...
                    <div class="client-details d-flex align-items-center mt-4">
                        <div class="thumb">
                            <img src="<?php echo e(getImage('assets/images/frontend/testimonial/' . @$testimonial->data_values->image, '75x75')); ?>"
                                alt="image">
                        </div>
                        <div class="content">
...
<?php /**PATH D:\Web Development\Lotto\ClickLuck\ClickLuck\resources\views/templates/basic/sections/testimonial.blade.php ENDPATH**/ ?>