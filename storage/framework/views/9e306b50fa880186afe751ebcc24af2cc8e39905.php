    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-2 col-md-3 text-md-start text-center">
                <a class="footer-logo" href="<?php echo e(route('home')); ?>"><img
                        src="<?php echo e(asset($activeTemplateTrue . 'images/logo.png')); ?>" alt="image"></a>
            </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 mt-md-0 mt-3">
                <ul class="inline-social-links d-flex align-items-center justify-content-md-end justify-content-center">
                    ...
                    <li><a href="<?php echo e(@$icon->data_values->url); ?>" target="_blank"><?php echo
                            @$icon->data_values->social_icon ?></a></li>
