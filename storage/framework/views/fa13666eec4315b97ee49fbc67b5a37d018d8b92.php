            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-card">
                    <div class="blog-card__thumb">
                        <img src="<?php echo e(getImage('assets/images/frontend/blog/' . @$blog->data_values->image, '768x512')); ?>"
                            alt="image">
                    </div>
                    <div class="blog-card__content">
                        ...
                        <a class="btn btn--base mt-4"
                            href="<?php echo e(route('blog.details', [slug($blog->data_values->title), $blog->id])); ?>"><?php echo app('translator')->get('Read
                            More'); ?></a>
                    </div>
                </div>
            </div>
...
<?php /**PATH D:\Web Development\Lotto\ClickLuck\ClickLuck\resources\views/templates/basic/sections/blog.blade.php ENDPATH**/ ?>