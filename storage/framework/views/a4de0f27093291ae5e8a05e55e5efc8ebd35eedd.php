...
<section class="loginPage pt-100 pb-100 position-relative z-index-2"
    style="background-image: url('<?php echo e(asset($activeTemplateTrue . 'images/HowToJoin.png')); ?>'); background-size: cover;">
    <div>
...
<?php endif; ?>
                        ...
                        <div class="d-flex justify-content-between flex-wrap">
                            ...
                            <div class="form-group text-end">
                                <a class="text-white" href="<?php echo e(route('user.password.request')); ?>"><?php echo app('translator')->get('Forget
                                    Password?'); ?></a>
                            </div>
                        </div>
                        ...
                        <p class="mt-3 text-center"><span class="text-white"><?php echo app('translator')->get('New to'); ?> <?php echo e($general->site_name); ?>
                                ...
                                ?</span> <a class="text--base" href="<?php echo e(route('user.register')); ?>"><?php echo app('translator')->get('Register'); ?></a>
                        </p>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Web Development\Lotto\ClickLuck\ClickLuck\resources\views/templates/basic/user/auth/login.blade.php ENDPATH**/ ?>