...
@section('content')
<section class="signupPage pt-100 pb-100 position-relative z-index-2"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form--control border-start-0 checkUser" id="mobile" name="mobile"
                                    type="text" value="{{ old('mobile') }}" required>
                            </div>
                        ...
                        <div class="col-12">
                            <button class="btn btn--base w-100 mt-3" id="recaptcha"
                                type="submit">@lang('Register')</button>
                            <p class="mt-3 text-center"><span class="text-white">@lang('Have an account') ?</span>
