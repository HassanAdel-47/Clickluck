            ...
            <div class="col-lg-4 col-md-6 mb-3">
                <div class="blog-card">
                    <div class="blog-card__thumb">
                        <img src="{{ getImage('assets/images/frontend/blog/' . @$item->data_values->image, '768x512') }}"
                            alt="image">
                    </div>
                    <div class="blog-card__content">
                        <h4 class="blog-card__title mb-3"><a
                                href="{{ route('blog.details', [slug($item->data_values->title), $item->id]) }}">{{
                                __(strLimit(@$item->data_values->title, 66)) }}</a>
                        </h4>
                        ...
                        <a class="btn btn--base mt-4"
                            href="{{ route('blog.details', [slug($item->data_values->title), $item->id]) }}">@lang('Read
                            More')</a>
                    </div>
                </div>
            </div>
