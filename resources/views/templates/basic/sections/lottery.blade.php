<section class="lottary overview-section pb-50 "
    ...
    <div class="lottary-container container w-100">
        ...
        <div class="row mt-4 d-flex justify-content-center align-items-center w-100">
            ...
            <div class="lottary__square__container col-12 col-md-6 col-xl-3 d-flex justify-content-center align-items-center wow bounceIn"
                ...
                <div class="lottary__square w-75 d-flex flex-column justify-content-center my-5 lg:my-0 ">
                    ...
                    <a class="btn p-2 btn--base--message mt-2" href="{{ route('lottery.details', $phase->id) }}">
            ...
            {{-- <div
                ...
                <div class="lottary__square w-75 d-flex flex-column justify-content-center my-5 lg:my-0 ">
                    ...
                    <a class="btn p-2 btn--base--message wow bounceInUp mt-2" data-wow-duration="1s"
                        data-wow-delay="0.1s" href="{{ @$banner->data_values->button_url }}">Buy Ticket $50.00</a>
        ...
        <div class="row mt-4 d-flex justify-content-center align-items-center w-100">
            <div class="col-lg-12 d-flex justify-content-center align-items-center">
                <a class="btn p-2 btn--base--message wow bounceInUp mt-4" data-wow-duration="1s" data-wow-delay="0.1s"
