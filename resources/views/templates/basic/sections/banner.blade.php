...
<section class="hero bg_img"
    ...
    <div class="container">
        <div class="wow bounceInUp row justify-content-center justify-content-lg-start">
            <div class="col-xxl-7 col-xl-8 col-lg-10 text-center text-lg-start w-100">
                <h2 class="hero__title text-center text-lg-start  col-lg-7 mt-4 mt-lg-0">
                    ClickLuck - Your Ticket to Excitement!</h2>
                <p class="hero__description text-justify  mt-5 mt-lg-3 col-lg-5">
                ...
                <div class="d-flex w-100 justify-content-evenly justify-content-lg-between mt-4 mt-lg-0">
                    <a class="btn btn--base mt-4" href="{{ route('lottery.machine', @$banner_phase->id) }}">{{
                        __(@$banner->data_values->button_name) }}</a>

                </div>
                @else
                <div class="d-flex w-100 justify-content-evenly justify-content-lg-between mt-4 mt-lg-0">
                    <a class="btn btn--base mt-4" href="{{ route('lottery') }}">{{
                        __(@$banner->data_values->button_name) }}</a>
