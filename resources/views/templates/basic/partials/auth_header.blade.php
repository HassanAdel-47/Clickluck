                        ...
                        @auth
                            ...
                            <ul class="sub-menu">
                                <li><a class="{{ menuActive('user.deposit.index') }}"
                                        href="{{ route('user.deposit.index') }}">@lang('Deposit Now')</a></li>
                                <li><a class="{{ menuActive('user.deposit.history') }}"
                                        href="{{ route('user.deposit.history') }}">@lang('Deposit History')</a></li>
                            </ul>
                        </li>

                        <li class="menu_has_children">
                            <a class="{{ menuActive(['user.withdraw', 'user.withdraw.history']) }}"
                                href="javascript:void(0)">@lang('Withdraw')</a>
                            <ul class="sub-menu">
                                <li><a class="{{ menuActive('user.withdraw') }}"
