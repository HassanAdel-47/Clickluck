        ...
        <div class="row align-items-center">
            <div class="col-lg-2 col-md-3 text-md-start text-center">
                <a class="footer-logo" href="{{ route('home') }}"><img
                        src="{{ asset($activeTemplateTrue . 'images/logo.png')}}" alt="image"></a>
            </div>
            <div class="col-lg-10 col-md-9 mt-md-0 mt-3">
                <ul
                    class="inline-menu d-flex justify-content-md-end justify-content-center align-items-center flex-wrap">
                    ...
                    <li><a href="{{ route('policy.pages', [slug($page->data_values->title), $page->id]) }}">{{
                            __($page->data_values->title) }}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 mt-md-0 mt-3">
                <ul class="inline-social-links d-flex align-items-center justify-content-md-end justify-content-center">
                    ...
                    <li><a href="{{ @$icon->data_values->url }}" target="_blank">@php echo
                            @$icon->data_values->social_icon @endphp</a></li>
                    @empty
                    @endforelse
                </ul>
            </div>
