                                ...
                                <td>
                                    <div class="button--group">
                                        ...
                                        <button class="btn btn-sm btn-outline--danger ms-1 confirmationBtn"
                                            data-id="{{ $lottery->id }}" data-status="{{ $lottery->status }}">
                                        ...
                                        <a class="btn btn-sm btn-outline--primary ms-1 editBtn"
                                            href="{{ route('admin.lottery.edit', $lottery->id) }}">
                                        ...
                                        <div class="dropdown-menu">
                                            <li>
                                                <a class="dropdown-item editBtn text--info"
                                                    href="{{ route('admin.lottery.win.bonus', $lottery->id) }}">
                                                    <i class="las la-trophy"></i> @lang('Set Win Bonus')
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item editBtn text--warning"
                                                    href="{{ route('admin.lottery.phase.single.lottery', $lottery->id) }}">
